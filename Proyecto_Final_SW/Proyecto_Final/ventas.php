        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="ventas.php" class="nav-link px-2 text-white">Ventas</a></li>
    ...
    <div class="container mt-4">
        ...
        <form class="row g-3 needs-validation" action="" method="post" novalidate>
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" name="b_producto" required>
                    <option selected disabled value="">Selecciona...</option>
                    <?php include 'sql/productos_para_ventas.php'; ?>        
                </select>
                <div class="valid-feedback">
                    Bien!
                </div>
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" name="tipo_de_pago" required>
                    <option selected disabled value="">Selecciona...</option>
                    <option value="Credito" name="Credito">Credito</option>
                    <option value="Debito" name="Debito">Debito</option>
                </select>
                <div class="valid-feedback">
                    Bien!
                </div>
            ...
            <div class="col-md-2">
                ...
                <input type="date" class="form-control" name="fecha_de_pago"required>
                <div class="valid-feedback">
                    Bien!
                </div>
            </div>
            <div class="col-12">
                <button class="btn btn-danger" type="submit" name="guardar_venta">Guardar venta</button>
            </div>
        </form>
    </div>
