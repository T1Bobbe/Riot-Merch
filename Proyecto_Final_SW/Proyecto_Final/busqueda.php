...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            ...
            <li><a href="busqueda.php" class="nav-link px-2 text-white">Busqueda</a></li>
    ...
    include 'SQL/actualizar.php';
    include 'SQL/borrar.php';
    ?>
    ...
    <form action="" method="POST">
        <div class="row">
            ...
            <div class="col-4 mt-3">
                <div class="mb-3">
                    <button type="submit" class="btn btn-danger w-100" name="nombre2">Buscar... </button>
                </div>
            </div>
        </div>
    </form>
